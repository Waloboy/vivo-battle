...
export default function ProfilePage() {
  ...
  const [rankPosition, setRankPosition] = useState<number | string>("ΓÇö");
  ...
  // ΓöÇΓöÇ Open Earnings Modal ΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Open Transactions Modal ΓöÇΓöÇ
  ...
  const handleSave = async () => {
    if (daysUntilChange !== null && profile.username !== originalUsername) {
      setSaveMessage("No puedes cambiar tu username a├║n.");
      return;
    }
    if (usernameStatus === "taken") {
      setSaveMessage("El username ya est├í en uso.");
      return;
    }
    ...
    if (user && profile) {
      ...
      if (error) {
        ...
        setSaveMessage("┬íPerfil guardado con ├⌐xito!");
        if (profile.username !== originalUsername) {
  ...
  // No loading gate — render immediately with whatever data we have.
    ...
    <div className="flex-1 max-w-2xl w-full mx-auto p-4 md:p-8 pb-24">
      ...
      {view === "office" ? (
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          {/* ΓöÇΓöÇ Estad├¡sticas Elite ΓöÇΓöÇ */}
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 cyber-glass rounded-[2rem] p-5 flex items-center justify-between border-white/5">
              <div>
                <p className="text-[10px] text-white/40 uppercase tracking-widest mb-1">Total Ganado Hist├│rico</p>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-[#ff007a]/5 rounded-xl p-3 border border-[#ff007a]/10">
                  ...
                  <p className="text-[10px] text-white/25 mt-0.5">Dep├│sitos ┬╖ Gifts</p>
                </div>
          ...
          {/* ΓöÇΓöÇ Historial de Batallas ΓöÇΓöÇ */}
          ...
          >
            <Edit2 size={16} /> Configuraci├│n de Perfil
          </button>
        </div>
      ) : (
        /* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
          ...
          <div className="cyber-glass rounded-3xl p-6 border-white/5">
            <div className="flex items-center gap-2 mb-5">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/30 uppercase tracking-wider">Informaci├│n de contacto y perfil p├║blico</p>
              </div>
            </div>
              ...
              <div className="space-y-1.5">
                ...
                {daysUntilChange !== null && profile?.username !== originalUsername && (
                  <p className="text-[10px] text-red-400 font-bold mt-1">
                    Debes esperar {daysUntilChange} d├¡as para cambiar tu username.
                  </p>
                )}
                {usernameStatus === "taken" && (
                  <p className="text-[10px] text-red-400 font-bold mt-1">
                    Este username no est├í disponible.
                  </p>
                )}
              </div>
          ...
          <div className="cyber-glass rounded-3xl p-6 border-white/5 mt-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label htmlFor="profile-email" className="text-[10px] font-bold text-white/40 uppercase tracking-widest">Correo Electr├│nico</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          ...
          {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
              BLOQUE 2: DATOS BANCARIOS / PAGO M├ôVIL
          ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
          <div className="cyber-glass rounded-3xl p-6 border border-[#ffd700]/10">
            <div className="flex items-center gap-2 mb-5">
              ...
              <div>
                <h2 className="text-lg font-black text-white">Datos Bancarios / Pago M├│vil</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label htmlFor="profile-id-card" className="text-[10px] font-bold text-[#ffd700]/60 uppercase tracking-widest">C├⌐dula</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              ...
              <div className="space-y-1.5">
                <label htmlFor="profile-phone" className="text-[10px] font-bold text-[#ffd700]/60 uppercase tracking-widest">Tel├⌐fono Pago M├│vil</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              ...
              <div className="bg-[#ffd700]/5 border border-[#ffd700]/10 rounded-xl p-3 text-[11px] text-[#ffd700]/60 leading-relaxed">
                ≡ƒÆí Estos datos ser├ín usados por el Admin para procesar tus retiros y enviar comprobantes de pago.
              </div>
            </div>
          </div>

          {/* ΓöÇΓöÇ Save Button + Message ΓöÇΓöÇ */}
          {saveMessage && (
              ...
              <div className="overflow-y-auto max-h-[65vh] p-4 space-y-2">
                {modalLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-white/25 text-sm">A├║n no tienes ganancias registradas.</p>
                  </div>
              ...
              <div className="overflow-y-auto max-h-[65vh] p-4 space-y-2">
                {modalLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-white/25 text-sm">Sin transacciones a├║n.</p>
                  </div>
                ) : txData.map((txn: any) => {
